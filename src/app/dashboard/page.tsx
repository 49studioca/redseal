...
import { getFirstLessonForBlock } from "@/lib/content/lesson-structure";
...
export default async function DashboardPage() {
  ...
  const isNewUser = totalQuestionsAttempted === 0;
  const firstLesson = blocks.length
    ? getFirstLessonForBlock(lessons, blocks[0].id)
    : undefined;
  const learnHref = firstLesson
    ? `/dashboard/learn/${firstLesson.slug}`
    : "/dashboard/learn";
      ...
      <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-[#64748B]">
            {isNewUser ? (
              <>
                Your personalized study hub for the{" "}
                    ...
                    <div className="mt-auto pt-3">
                      ...
                      {isAssessed && (
                        <div className="mt-1 flex items-center justify-between font-[family-name:var(--font-ibm-mono)] text-xs text-[#64748B]">
                          ...
                          <span>
                            {blockStats?.questions_correct ?? 0}/{attempts}{" "}
                            correct
                          </span>
                        </div>
                      )}
            ...
            <Link href="/dashboard/mock-exam">
              <Card className="cursor-pointer p-6 transition hover:border-[#C0271E] hover:shadow-lg">
                ...
                <p className="mt-1 text-sm text-[#64748B]">
                  ...
                  {trade.exam_time_minutes / 60}h · {trade.pass_percentage}% to
                  pass
                </p>
              </Card>
            </Link>
